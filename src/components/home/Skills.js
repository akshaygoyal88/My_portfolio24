...
import { skillsSection } from "../../info/Info";

const Skills = () => {
  return (
    skillsSection && (
      <Fade bottom duration={2000}>
        <Container className="d-flex justify-content-center align-items-center flex-column my-5 section section-lg">
          ...
          {skillsSection.data.map((section, index) => {
            return (
              <Row className="my-5" key={index}>
                ...
                <Col lg="12" className="d-flex justify-content-center align-items-center flex-column order-1 order-lg-2">
